...
export default function Login() {
	...
	return (
		<div className="flex justify-between min-h-screen w-full bg-[linear-gradient(to_bottom,#F8B4F0,#C7F9F8)] backdrop-blur-md">
			...
			<div className="flex flex-col mt-30 mr-40 items-center h-105 w-90 rounded-xl bg-[#F3CEF6]/90 backdrop-blur-xl border border-white/40 shadow-[0_20px_40px_rgba(147,112,219,0.15)]">
				...
				<button className="flex items-center justify-center bg-[#f9ecf7] h-10 w-70 p-2 gap-2 rounded-md cursor-pointer text-gray-700">
