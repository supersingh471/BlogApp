	...
	return (
		<div className="flex justify-between min-h-screen w-full bg-[linear-gradient(to_bottom,#FFFFFF,#F4F3FB)] backdrop-blur-md">
			<div className="h-130 w-110 mt-10 ml-20 p-4">
				...
				<p className="font-semibold text-4xl text-gray-800 mt-20">Welcome Back!</p>
				<p className="text-lg text-gray-700">Log in to continue your journey</p>
			</div>
			
			<div className="flex flex-col mt-30 mr-40 items-center h-105 w-90 rounded-xl bg-white backdrop-blur-xl border border-gray-300 shadow-[0_20px_40px_rgba(147,112,219,0.15)]
 ">
				...
				}} className="bg-[#f0f3fbe0] hover:bg-[#ced2db] text-gray-700 p-2 w-70 py-1.5 mt-6 rounded-md focus:outline-none" type="text" placeholder="Email" />
				<input onChange={(e) => {
					setPassword(e.target.value);
				}} className="bg-[#f0f3fbe0] hover:bg-[#ced2db] text-gray-700 p-2 w-70 py-1.5 mt-6 rounded-md focus:outline-none" type="password" placeholder="Password" />

				<button onClick={signin} className="flex items-center h-10 w-70 mt-8 mx-5 bg-[#19191C] hover:bg-[#030407] rounded-md text-white text-md font-semibold cursor-pointer">
				...
				<button className="flex items-center justify-center bg-[#f0f3fbe0] hover:bg-[#000000] hover:text-white h-10 w-70 p-2 gap-2 rounded-md cursor-pointer text-gray-700">
				...
				<div className="mt-4 text-gray-700">Don't have an account?
