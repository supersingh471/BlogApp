...
export default function UserDropDownMenu() {
	...
	return (
		<div className="flex absolute top-12.5 right-0 bg-white dark:bg-gray-900">
		...
		<div className="flex flex-col w-70 shadow-[0_5px_5px_rgba(0,0,0,0.2)] border border-zinc-300 rounded-xl">
			...
			<div className="flex gap-3 p-2 m-2 w-65 rounded-lg hover:bg-zinc-100 dark:hover:bg-gray-700 cursor-pointer">
			<span className="flex items-center justify-center w-12 h-12 font-bold text-xl bg-gray-300 rounded-full fill-[#c0c4eb]">
					VS
				</span>
				<div className="flex flex-col h-14 ">
				<h1 className="text-zinc-700 dark:text-gray-100 text-xl font-semibold h-7">Vikash Singh</h1>
				
					<p className="font-semibold text-zinc-500 dark:text-zinc-300">@noobcoder471</p>
				</div>
			</div>
			</div>

			<div className="border-b border-gray-300 text-[#57575b] dark:text-gray-100">
				<div className="flex flex-col m-2">
					<span className="flex gap-2 px-4 py-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-gray-700 cursor-pointer">
					...
					<span className="flex gap-2 px-4 py-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-gray-700 cursor-pointer"><svg fill="none" viewBox="0 0 20 16" width="20" height="22"><path stroke="currentColor" d="M4.262 14.83a7.5 7.5 0 1 0-.387-9.158m2.167.784-3.085.2-.2-3.086m6.994 3.432v2.994l2.248 1.505" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.25"></path></svg>
						My reading history
					</span>
			...
			<button onClick={handleLogout} className="m-1.5 text-[#ef3a49]">
					<span className="flex gap-2 px-4.5 py-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-gray-700 ursor-pointer">
