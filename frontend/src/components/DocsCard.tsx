	...
	return (
		<div className="w-145">
			...
			<div className="flex flex-col w-100 p-5">
				...
				<div className="flex items-center  border-t border-gray-300 w-133 h-15 mt-6 gap-5 text-gray-500 dark:border-gray-700 dark:text-gray-100 font-semibold">
